...
A través de este repositorio y mis proyectos individuales, voy a ir documentando mi aprendizaje continuo, laboratorios prácticos y la preparación de certificaciones del sector.
...
| **Seguridad Web** | bWAPP Web Vulnerability Assessment & Defensive Analysis (OWASP Top 10) | `bWAPP`, `Bee-Box`, `Burp Suite`, `PHP`, `MySQL` | Beginner | [📄 Ver Lab](/cybersecurity-portfolio/posts/web-vuln-assessment/) |
| **Seguridad en Redes** | Network Reconnaissance & Vulnerability Assessment with Nmap and Wireshark | `Nmap`, `Wireshark`, `Samba`, `ProFTPD`, `UnrealIRCd` | Beginner | [📄 Ver Lab](/cybersecurity-portfolio/posts/net-reco-vuln-nmap-wireshark/) |
...
¿Quieres conectar conmigo o hablar sobre ciberseguridad? 

* **LinkedIn:** [linkedin.com/in/kevinlopezgranado](https://linkedin.com/in/kevinlopezgranado)
* **Correo:** kevin.lopez.granado@hotmail.com